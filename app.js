...
// let localScore= localStorage.setItem("highScore", Math.abs(Number(pcScoreSpan.textContent)-Number(yourScoreSpan.textContent)))
// let newScore=Math.abs(Number(pcScoreSpan.textContent)-Number(yourScoreSpan.textContent))
//   console.log(newScore);
//   if (newScore>0){
//       localStorage.setItem("highScore", newScore)
//       topScoreSpan.textContent= `${pcScoreSpan.textContent}:${yourScoreSpan.textContent}`
//     } 
    
// topScoreSpan.textContent= `${+yourScoreSpan.textContent} : ${+pcScoreSpan.textContent}`
// console.log(topScoreSpan.textContent);
// console.log(+localStorage.getItem("high score"));
const topScore=() => {let newScore=Math.abs(Number(pcScoreSpan.textContent)-Number(yourScoreSpan.textContent))
  if(newScore>+localStorage.getItem("high score")){
    ...
    console.log(+localStorage.getItem("high score"));
      ...
      localStorage.setItem("top score", `${+yourScoreSpan.textContent} : ${+pcScoreSpan.textContent}`)
      topScoreSpan.textContent=localStorage.getItem("top score")
